...
1. **Match Setup**: Join via 5-digit alphanumeric PIN
2. **Exploration**: Map starts in fog of war, gradually revealed as players explore
3. **Objective**: Destroy enemy eagle while defending your own
4. **Combat**: Grid-based movement, strategic shooting, power-up control
5. **Victory Conditions**: Eagle destruction or time-based scoring
6. **Progression**: Round-based matches (Bo3 format)
